          ...
          <div className="space-y-6">
              ...
              {visibleData.map((_, i) => (
                ...
                >
                  <CardHeader className="p-0">
                    <div className="relative w-full h-[160px] sm:h-[200px] md:h-[260px]">
                      <Image
                  ...
                  <CardContent className="text-center md:py-2 md:px-2">
                    ...
                    <p className="text-white/70 text-[10px] sm:text-xs md:text-sm mt-0.5">
                      Moonton
                    </p>
                  </CardContent>
                </Card>
            ...
            <div className="flex justify-center">
              <button
                ...
                className="px-6 py-2 rounded-full font-bold text-sm bg-primary text-white hover:scale-105 transition dark:text-gray-900 cursor-pointer"
              >
